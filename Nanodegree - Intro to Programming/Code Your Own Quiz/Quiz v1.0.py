...
def intro():
	...
	answer = defensive(raw_input("whiche difficulty do you want to play on? (choose from easy/medium/hard): "), "difficulty")    # defensive(str, str) is the used function to check user input for invalid input
	return answer
...
def congrats():
	...
	answer = defensive(raw_input("Do you want to play another time? (yes/no): "), "continue")
	if answer == "yes":
		return True
	else:
		return False
...
def ask(number_of_questions):
	...
	for number in range(0, number_of_questions):
		...
		print question[0]
		answer = defensive(raw_input("Your answer: "), "question")
		if answer == question[1]:
			...
			while True:
				print "Incorrect"
				answer = defensive(raw_input("Try again: "), "question")
